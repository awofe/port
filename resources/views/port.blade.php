...
<html>
<head>
<title>Falolu Olaitan Portfolio</title>
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, Sony Ericsson, Motorola web design, Falolu Olaitan, Developer Awofe, IT specialist on linkedln" />
<!-- webfonts -->
		...
		<!-- container -->
			...
			<div id="home" class="header">
				...
				<div class="top-header">
					...
					<div class="logo">
						<h1><a href="index.html"><span>IT</span>Specialist</a></h1>
					</div>
					<div class="navigation-right">
						<span class="menu"><img src="bootstrap/images/menu.png" alt=" " /></span>
			...
			<div class="banner-info">
				<div class="col-md-7 header-right">
					<h1>Hi !</h1>
					<h6>Frontend Developer & Cloud Operation Engineer</h6>
					<ul class="address">
					
					<li>
							<ul class="address-text">
								<li><b>NAME</b></li>
								<li>I'M Olaitan Falolu</li>
							</ul>
						</li>
						<li>
							<ul class="address-text">
						...
						<li>
							<ul class="address-text">
								<li><b>PHONE </b></li>
                                <li>+234-8104656502</li>
                                <li>+234-7063842535</li>
							</ul>
						</li>
						<li>
							<ul class="address-text">
								<li><b>ADDRESS </b></li>
								<li>Jakande Estate Isolo, Lagos, Nigeria.</li>
							</ul>
						</li>
						<li>
							<ul class="address-text">
								<li><b>E-MAIL </b></li>
								<li><a href="mailto:example@mail.com"> olaitanfalolu02@gmail.com</a></li>
							</ul>
						</li>
						<li>
							<ul class="address-text">
								<li><b>WEBSITE </b></li>
								<li><a href="#work">www.myresume.com</a></li>
							</ul>
						</li>
				...
				<div class="col-md-5 header-left">
					<img src="bootstrap/images/20190527_111001.jpg" alt="">
				</div>
				<div class="clearfix"> </div>
						...
						<div class="resp-tabs-container">
							<div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
								<div class="col-md-3 team-gd ">
										...
										<a href="#portfolioModal1" class="portfolio-link b-link-diagonal b-animate-go" data-toggle="modal"><img src="bootstrap/images/pic4.jpg" alt="">
								...
								<div class="col-md-3 team-gd ">
										...
										<a href="#portfolioModal3" class="portfolio-link b-link-diagonal b-animate-go" data-toggle="modal"><img src="bootstrap/images/pic5.jpg" alt="">
								...
								<div class="col-md-3 team-gd ">
										...
										<a href="#portfolioModal2" class="portfolio-link b-link-diagonal b-animate-go" data-toggle="modal"><img src="bootstrap/images/pic9.jpg" alt="">
								...
								<div class="col-md-3 team-gd ">
										...
										<a href="#portfolioModal4" class="portfolio-link b-link-diagonal b-animate-go" data-toggle="modal"><img src="bootstrap/images/pic6.jpg" alt="">
								...
								<div class="col-md-3 team-gd yes_marg ">
										...
										<a href="#portfolioModal5" class="portfolio-link b-link-diagonal b-animate-go" data-toggle="modal"><img src="bootstrap/images/pic10.jpg" alt="">
								...
								<div class="col-md-3 team-gd yes_marg ">
										...
										<a href="#portfolioModal6" class="portfolio-link b-link-diagonal b-animate-go" data-toggle="modal"><img src="bootstrap/images/pic11.jpg" alt="">
								...
								<div class="col-md-3 team-gd yes_marg ">
										...
										<a href="#portfolioModal7" class="portfolio-link b-link-diagonal b-animate-go" data-toggle="modal"><img src="bootstrap/images/pic13.jpg" alt="">
								...
								<div class="col-md-3 team-gd yes_marg ">
										...
										<a href="#portfolioModal8" class="portfolio-link b-link-diagonal b-animate-go" data-toggle="modal"><img src="bootstrap/images/pic14.jpg" alt="">
					...
					<div class="container">
					   ...
					   <div class="news-grid w3l-agile">
					    <div class="col-md-6 news-img">
						  <a href="#" data-toggle="modal" data-target="#myModal1"> <img src="bootstrap/images/b1.jpg" alt=" " class="img-responsive"></a>
					  ...
					  <div class="news-grid">
						...
						<div class="col-md-6 news-img two">
						   <a href="#" data-toggle="modal" data-target="#myModal1"> <img src="bootstrap/images/b2.jpg" alt=" " class="img-responsive"></a>
					  ...
					  <div class="news-grid">
					    <div class="col-md-6 news-img">
						  <a href="#" data-toggle="modal" data-target="#myModal1"> <img src="bootstrap/images/b3.jpg" alt=" " class="img-responsive"></a>
    ...
    <div class="modal-content port-modal">
        ...
        <div class="container">
			<div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <div class="modal-body">
                        <img src="bootstrap/images/pic1.jpg" class="img-responsive img-centered" alt="">
                    </div>
                </div>
            </div>
        </div>
