...
<head>
   ...
   ================================================== -->
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
 	...
 	<!-- CSS
   ================================================== -->
   <link rel="stylesheet" href="bootstrap2/css/base.css">  
   <link rel="stylesheet" href="bootstrap2/css/main.css">
   <link rel="stylesheet" href="bootstrap2/css/vendor.css">     

   <!-- script
   ================================================== -->   
	<script src="bootstrap2/js/modernizr.js"></script>
	<script src="bootstrap2/js/pace.min.js"></script>
...
<body id="top">
   		...
   		<div class="row">
   			...
   			<div class="col-twelve">
	   			...
	   			<p class="intro-position">
	   				...
	   				<span>Cloud Operation Engineer</span> 
	   			</p>
   ...
   <section id="about">  
   	...
   	<div class="row section-intro">
   		<div class="col-twenty">
   			...
   			<div class="intro-info">
   				...
   				<img src="bootstrap2/images/ollly.jpg" alt="Profile Picture">

   				<p class="lead">An IT enthusiast with an undying attitude for learning new technologies. Leverage technical, analytical and problem-solving skills to create dynamic, high-speed websites, apps and platforms fueling competitive advantage and revenue growth. I have an extensive knowledge in Microsoft Servers, Linux systems and cloud technologies. As part of my everyday job I ensure uptime of workloads hosted in public cloud (Azure and AWS) and migrating workloads across a host of different systems.</p>
   			</div>   			
   	...
   	<div class="row about-content">
   		...
   		<div class="col-six tab-full">
   			...
   			<h3>Profile</h3>
   			<p> Seeking a Cloud Infrastructure Engineer/Architect positions utilizing my expertise in driving conceptualize operational architectural solution by leading efforts to implement business solutions
				driving revenue gains and cost savings throughout the organization</p>

   			<ul class="info-list">
   				<li>
   					<strong>Fullname:</strong>
   					<span>Falolu Olaitan Emmanuel</span>
   				</li>
   				<li>
   				...
   				<li>
   					<strong>Job:</strong>
   					<span>IT Specialist | Cloud Operation Engineer</span>
   				</li>
   				<li>
   					<strong>Website:</strong>
   					<span>www.anchorteck.net</span>
   				</li>
   				<li>
   					<strong>Email:</strong>
   					<span>Olaitanfalolu02@gmail.com</span>
   				</li>
   		...
   		<div class="col-six tab-full">
   			...
   			<h3>Skills</h3>
   			<p>HTML5; XHTML; CSS3; JavaScript; jQuery; PHP; Python: SQL; Mysql workbench; Bootstrap; WordPress; Google Analytics; AJAX; CMS Tools; Ionics (Mobile app)</p>
   	...
   	<div class="row button-section">
   		<div class="col-twelve">
   			...
   			<a href="/bootstrap2/cv/Falolu Olaitan.pdf" target="_blank" title="Download CV" class="button button-primary">Download CV</a>
   		</div>   		
   	</div>
   			...
   			<div class="timeline-wrap">
   				...
   				<div class="timeline-block">
	   				...
	   				<div class="timeline-header">
	   					<h3>Cloud Operation Engineer</h3>
	   					<p>May 2019 - Present</p>
	   				</div>

	   				<div class="timeline-content">
	   					<h4>Tek-Experts</h4>
	   					<p>-Successfully managed to support global customers on issues related to Web Application management and maintenance in their App service<br> - Utilized my in depth knowledge and understanding of the Web Application aspect of App Service to help customers properly analyze and provide solutions to the issues they were facing with regards to the platform end of their web application.<br> - Played a key role in providing proper guidance recommendation to customers who needed information with regards to where to get started in moving their web applications from their on-premises environment to the cloud.<br> - Provided insightful information to customers on ways through which they can leverage on continuous deployment and what deployment options that they had access to that will work hand in hand with the cloud web application platform </p>
	   				</div>
	   			...
	   			<div class="timeline-block">
	   				...
	   				<div class="timeline-content">
	   					<h4>SPAR Nigeria</h4>
	   					<p>Frontend Developer: Develop the Company website and also built the service help desk (Google Developer) for the company, Manage KPIs in Manage Engine App.<br>  Database management: Worked as an ERP engineer, data entry. </p>
	   				</div>
				   ...
				   <div class="timeline-block">
					...
					<div class="timeline-header">
						<h3>IT Engineer</h3>
						<p>June 2018 - September 2019</p>
					</div>

					<div class="timeline-content">
						<h4>SPAR Nigeria</h4>
						<p>System Administrator: I handled the installations of software’s Office 365, Active  
							Directory, and application for users.<br> Network Administrator: setting firewall and also configuring the Sophos XG firewall. <br>
							Project management: I handled the setup of one of the company stores at Opebi, ikeja Lagos. Where I handled the systems, CCTV installations. <br>  Database management: Worked as an ERP engineer, data entry. </p>
					</div>
   		...
   		<div class="col-twelve">
   			...
   			<div class="timeline-wrap">
   				...
   				<div class="timeline-block">
	   				...
	   				<div class="timeline-header">
	   					<h3>Graduate Training Program GTP (INFORMATION TECHNOLOGY)</h3>
	   					<p>September 2017 - April 2018</p>
	   				</div>

	   				<div class="timeline-content">
	   					<h4>Pan African Graduate School, Port Harcourt.</h4>
	   					<p>Professional Certification in Computer Networking <br>
							Professional Certification in Web Development  <br>
							Professional Certification in Data Analysis and Interpretation <br>
							Professional Certification Project Management CPMP </p>
	   				</div>
	   			...
	   			<div class="timeline-block">
	   				...
	   				<div class="timeline-header">
	   					...
	   					<p>October 2011 - Feburary 2017</p>
	   				</div>
   ...
   <!-- Java Script
   ================================================== --> 
   <script src="bootstrap2/js/jquery-2.1.3.min.js"></script>
   <script src="bootstrap2/js/plugins.js"></script>
